...
async function addAllGrants() {
  try {
    ...
    const csbfpGrant = {
      ...
      applicationProcess: null, // Changed from string to null
      documents: [
        "Business plan",
      ...
      organization: null,
      contactPhone: null,
      whoCanApply: null, // Changed from array to null
      industryFocus: null, // Changed from array to null
      ...
      howToApply: null, // Changed from string to null
      reviewProcess: null,
      restrictions: null,
      faqQuestions: null,
      faqAnswers: null
    ...
    const canExportGrant = {
      ...
      type: "federal",
      imageUrl: "https://images.unsplash.com/photo-1599751449029-c87714f5cd13?auto=format&fit=crop&w=500&h=280&q=80",
      deadline: "Ongoing (applications accepted year-round)",
