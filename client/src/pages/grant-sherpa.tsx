...
export default function GrantSherpa() {
  ...
  const assistMutation = useMutation({
    mutationFn: async () => {
      return await apiRequest("POST", "/api/grantsherpa/assist", {
    ...
    onSuccess: (data: any) => {
      ...
      toast({
        ...
        description: "Your grant application has been analyzed by GrantSherpa."
      });
    },
    onError: () => {
      toast({
  ...
  const plagiarismMutation = useMutation({
    mutationFn: async () => {
      return await apiRequest("POST", "/api/grantsherpa/plagiarism-check", {
        text: textToCheck
      });
    },
    onSuccess: (data: any) => {
  ...
  const ideasMutation = useMutation({
    mutationFn: async () => {
      return await apiRequest("POST", "/api/grantsherpa/generate-ideas", {
      ...
      <div className="container mx-auto">
        <div className="flex flex-col items-center mb-10 text-center">
          <div className="flex items-center mb-6">
            ...
            <h1 className="text-4xl md:text-5xl font-bold">GrantSherpa</h1>
          </div>
                ...
                <CardFooter className="block border-t border-gray-700 pt-6">
                  ...
                  <div className="space-y-6">
                    ...
                    {ideas.alignmentNotes && (
                      <div>
                        <h4 className="font-medium mb-3">Alignment with Grant Objectives</h4>
                        <div className="bg-[#333] p-4 rounded-md text-gray-300">
                          {ideas.alignmentNotes}
                        </div>
                      </div>
                    )}
                    ...
                    {ideas.budgetConsiderations && (
                      <div>
                        <h4 className="font-medium mb-3">Budget Considerations</h4>
                        <ul className="list-disc pl-5 space-y-1 text-gray-300">
                    ...
                    {ideas.impactMetrics && (
                      <div>
                        <h4 className="font-medium mb-3">Impact Measurement</h4>
                        <ul className="list-disc pl-5 space-y-1 text-gray-300">
