...
export default function GrantCard({ grant }: GrantCardProps) {
  ...
  return (
    <Link href={`/grant/${grant.id}`}>
      <a className="netflix-card block cursor-pointer h-full transition-transform duration-200 hover:scale-105 bg-black bg-opacity-80 rounded-md overflow-hidden border border-gray-800">
